  ...
  return (
    <PageLayout>
      <PageGrid>
        ...
        {/* Middle Column */}
        <GridCol span={6}>
          <PageHeader title="Step 8 — SAP DMC Preload Export" subtitle="Generate LTMC-compatible CSV and XLSX preload files for SAP S/4HANA upload">
          ...
          <Card>
            ...
            <CardBody>
              <InfoBox variant="info">
                <strong className="text-primary-600 dark:text-primary-400">Upload Steps in SAP S/4HANA LTMC:</strong><br /><br />
                1. Transaction <strong>LTMC</strong> → Create Migration Project<br />
                2. Select Template: <strong>{obj.dmc || '—'}</strong><br />
                3. Source File → Upload the downloaded CSV file<br />
                4. Map Columns → Validate column alignment<br />
                5. <strong>Simulation Run</strong> → Review errors (no data posted)<br />
                6. Fix remaining errors → <strong>Production Run</strong><br />
                7. Verify in <strong>{obj.tcode || '—'}</strong> / SE16N table view
              </InfoBox>
