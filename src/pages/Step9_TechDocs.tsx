    ...
    <PageLayout>
      <div className="max-w-[1080px] mx-auto space-y-6 bg-[var(--bg-secondary)] border border-[var(--border)] shadow-[var(--shadow-sm)] rounded-xl p-8">
        <div>
          ...
          <p className="text-[13px] text-[var(--text-secondary)] mt-1">SAP S/4HANA Data Migration Studio v3.0 — Complete Architecture, Design & Implementation Reference</p>
          <div className="flex gap-2 flex-wrap mt-3">
            ...
            <Badge variant="violet">3 SAP Objects</Badge>
